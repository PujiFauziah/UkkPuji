...
class Laporan extends BaseController
{
	...
	public function pengaduanTampil(){
		...
		<button href"/print" onclick="window.print()" class="btn btn-info btn-sm mr-2"<i class="fa fa-print"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-break-fill" viewBox="0 0 16 16">
