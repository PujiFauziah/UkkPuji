...
// route masyarakat
$routes->get('/', 'Controllermasyarakat::index');
...
$routes->get('/masyarakat/laporan', 'Controllermasyarakat::laporan');
...
$routes->get('/laporan/download-excel/(:any)', 'Laporan::excel/$1',['filter'=>'otentifikasi']);
$routes->get('/laporan/download-pdf/(:any)', 'Laporan::pdf/$1',['filter'=>'otentifikasi']);
