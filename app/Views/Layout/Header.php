...
<a class="navbar-brand" href="/dashboard">APMJ</a>
...
<a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown"><i class="fas fa-database"></i>  Data User </a>
...
<?php } ?>
<li class="nav-item">
<a class="nav-link" href="/logout" OnClick="return confirm('Anda Yakin Keluar ?')">Keluar</a>
</li>
</ul>
</div>
</nav>
