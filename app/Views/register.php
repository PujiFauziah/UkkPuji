...
<html lang="en">
  <head>
	...
	<body class="img js-fullheight" style="background-image: url(images/paseban1.jpg);">
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">From Registrasi Aplikasi Pengaduan Masyarakat Desa Jambar</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
                  ...
                  <div class="form-group">
		      			<input name="txtNik" maxlength="16" type="text" class="form-control" placeholder="NIK" required>
                    </div>
					<div class="form-group">
				...
				<div class="form-group">
		      			<input name="txtTelp" maxlength="13" type="text" class="form-control" placeholder="Nomor Telepone" required>
                    </div>
	            <div class="form-group">
